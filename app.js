function initCanvas(){
    ...
    var naveImage   = new Image(); // nau
    var enemiespic1  = new Image(); // enemic 1
    var enemiespic2 = new Image(); // enemic 2
    ...
    function Launcher(){
        // Ubicació de les bales
        this.y = 500,
        this.x = cW*.5-25,
        this.w = 100,
        this.h = 100,
        this.direccion,
        this.bg="white", //Color de les bales
        this.misiles = [];
